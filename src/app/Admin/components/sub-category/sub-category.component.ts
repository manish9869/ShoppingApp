...
export class SubCategoryComponent implements OnInit, OnDestroy {
  ...
  onSaveSubCategory() {
    ...
    if (this.mode === "create") {
      this.subCategoryService
        .createSubCategory(
          this.CategoryId,
          this.form.value.SubCategoryName,
          this.form.value.SubCategoryDescription
        )
        .subscribe(
          (result) => {
            this.resetForm();
  ...
  onEdit(SubCategoryid: string) {
    ...
    this.subCategoryService.getSingleSubCategorydb(SubCategoryid).subscribe(
      (result) => {
        console.log(result);
        this.SubCategory = {
  ...
  onChange($event: MatSlideToggleChange, SubCategoryid: string) {
    this.subCategoryService
      .UpdateCategoryStatus(SubCategoryid, $event.checked)
      .subscribe(
        (result) => {
          this.resetForm();
